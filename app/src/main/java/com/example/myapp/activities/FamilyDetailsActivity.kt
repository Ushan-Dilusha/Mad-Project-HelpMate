...
class FamilyDetailsActivity : AppCompatActivity() {
    ...
    private fun deleteRecord(
        ...
        mTask.addOnSuccessListener {
            Toast.makeText(this, "Employee Details deleted", Toast.LENGTH_LONG).show()
    ...
    private fun openUpdateDialog(
        ...
        btnUpdateData.setOnClickListener {
            ...
            Toast.makeText(applicationContext, "User Details Updated", Toast.LENGTH_LONG).show()
    ...
    private fun updateEmpData(
        ...
        val dbRef = FirebaseDatabase.getInstance().getReference("Employees").child(id)
        val empInfo = FamilyModel(id, name, age, salary)
