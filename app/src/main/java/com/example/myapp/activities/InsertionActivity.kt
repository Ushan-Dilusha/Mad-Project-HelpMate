...
class InsertionActivity : AppCompatActivity() {
    ...
    private fun saveEmployeeData() {
        ...
        if (empName.isEmpty()) {
            etEmpName.error = "Please Enter Package Name"
        }
        if (empAge.isEmpty()) {
            etEmpAge.error = "Please enter Contribute Association"
        }
        ...
        dbRef.child(empId).setValue(employee)
            .addOnCompleteListener {
                Toast.makeText(this, "Package Added Successfully", Toast.LENGTH_LONG).show()
